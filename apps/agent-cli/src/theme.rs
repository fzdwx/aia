...
/// 用户标签行：Cyan + Bold
pub const USER_LABEL_STYLE: Style =
    Style::new().fg(Color::Cyan).add_modifier(Modifier::BOLD);

/// 助手标签行：Green + Bold
pub const ASSISTANT_LABEL_STYLE: Style =
    Style::new().fg(Color::Green).add_modifier(Modifier::BOLD);

/// 工具调用：Yellow 前景 + Dim
pub const TOOL_STYLE: Style =
