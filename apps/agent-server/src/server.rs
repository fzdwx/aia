...
pub fn build_router(state: Arc<AppState>) -> Router {
    Router::new()
        .route("/api/providers", get(routes::ProviderRouteService::get_providers))
        .route("/api/providers/list", get(routes::ProviderRouteService::list_providers))
        ...
        .route("/api/providers", post(routes::ProviderRouteService::create_provider))
        .route("/api/channels", post(routes::create_channel))
        .route("/api/providers/{name}", put(routes::ProviderRouteService::update_provider))
        .route("/api/channels/{id}", put(routes::update_channel))
        .route("/api/providers/{name}", delete(routes::ProviderRouteService::delete_provider))
        .route("/api/channels/{id}", delete(routes::delete_channel))
        .route("/api/providers/switch", post(routes::ProviderRouteService::switch_provider))
