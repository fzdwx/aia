...
use agent_core::{
    AbortSignal, CompletionRequest, CompletionSegment, ConversationItem, LanguageModel, Message,
...
impl RuntimeError {
    ...
    fn duplicate_tool_call(call: &ToolCall, previous: &PreviousToolCall) -> Self {
        Self {
            message: format!(
