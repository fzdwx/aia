...
fn tool_descriptions_are_loaded_from_markdown() {
    let cases: [(&str, &str); 13] = [
        ...
        (
            widget_readme_tool_description(),
            include_str!("../../prompts/tool/widget_readme.md").trim(),
        ),
        (
            widget_renderer_tool_description(),
            include_str!("../../prompts/tool/widget_renderer.md").trim(),
        ),
        (
