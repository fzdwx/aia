...
- Use TapeInfo to check estimated context usage and pressure_ratio.
- When pressure_ratio exceeds {{agent_handoff_threshold}}, you SHOULD use TapeHandoff to compress history.
