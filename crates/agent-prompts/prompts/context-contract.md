...
- Use tape_info to check estimated context usage and pressure_ratio.
- When pressure_ratio exceeds {{agent_handoff_threshold}}, you SHOULD use tape_handoff to compress history.
